...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-phone]');
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); //cheackNumInputs('input[name="user_phone"]');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        textMessage.textContent = message.failere;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var mask = function mask(selector) {
  ...
  var onPhoneInput = function onPhoneInput(e) {
    ...
    if (['7', '8', '9'].indexOf(inputNumberValue[0]) > -1) {
      ...
      var firstSymbol = inputNumberValue[0] == '8' ? '8' : '+7';
...
var modal = function modal() {
  ...
  function bindModal(callEngineerBtn, modalEngineer, closeEngineer) {
    var destroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var triger = document.querySelectorAll(callEngineerBtn),
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      if (!btnScroll && document.documentElement.clientHeight + window.pageYOffset >= document.documentElement.scrollHeight) {
...
var showMoreStyles = function showMoreStyles(triger, wrapper) {
  var card = document.querySelectorAll(wrapper),
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    var ptevBtn = document.querySelector(prev),
        nextBtn = document.querySelector(next);
    ptevBtn.addEventListener('click', function () {
      plusSlides(-1);
